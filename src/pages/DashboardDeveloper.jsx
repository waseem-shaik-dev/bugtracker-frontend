...
export default function DashboardDeveloper() {
  ...
  const topCards = [
    { label: "Your Projects",  value: stats?.totalProjects, icon: FolderOpen, color: "text-blue-600 dark:text-blue-400", bgColor: "bg-blue-50 dark:bg-blue-900/30", delay: "0.05s" },
    { label: "Assigned Bugs",  value: stats?.totalBugs,     icon: Bug,        color: "text-red-600 dark:text-red-400",       bgColor: "bg-red-50 dark:bg-red-900/30",       delay: "0.1s" },
  ];

  const statusCards = [
    { label: "Open",        value: stats?.openBugs,        color: "bg-sky-500",     delay: "0.15s" },
    { label: "In Progress", value: stats?.inProgressBugs,  color: "bg-amber-500",   delay: "0.20s" },
    { label: "Resolved",    value: stats?.resolvedBugs,    color: "bg-emerald-500", delay: "0.25s" },
    { label: "Closed",      value: stats?.closedBugs,      color: "bg-slate-400",   delay: "0.30s" },
  ];
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-3 group/desc">
                        <HoverPopover content={<DescriptionHoverContent title="Bug Description" description={bug.description} />}>
                          <span className="text-[13px] text-slate-500 dark:text-slate-400 truncate cursor-pointer border-b border-dashed border-slate-200 dark:border-slate-700 hover:text-blue-600 dark:hover:text-blue-400 hover:border-blue-400 transition-colors duration-200 w-[160px] inline-block align-middle">
